...
order.post('/orders', authenticateToken, (req, res) => {
    knex
        .select("*")
        .from("shopping_cart")
...
order.get('/orders/:order_id', authenticateToken, (req, res) => {
...
order.get('/orders/inCustomer/data', authenticateToken, (req, res) => {
...
order.get('/orders/shortdetail/:order_id', authenticateToken, (req, res) => {
