...
product.get('/product/inCategory/:category_id',(req,res)=>{
    ...
    'name','description','price','discounted_price','thumbnail')
    .from('product')
...
product.get('/product/:product_id/details',(req,res)=>{
    ...
    knex.select('name','description','price','discounted_price','image','image_2')
    .from('product')
...
product.post('/products/:product_id/review',authenticateToken,(req,res)=>{
